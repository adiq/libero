...
use Adiq\LiberoBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdiqLiberoBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("AdiqLiberoBundle:Book:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdiqLiberoBundle:Book')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdiqLiberoBundle:Book:edit.html.twig")
     */
