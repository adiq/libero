...
use Adiq\LiberoBundle\Form\ReaderType;
...
class ReaderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdiqLiberoBundle:Reader')->findAll();
     ...
     *
     * @Route("/", name="reader_create")
     * @Method("POST")
     * @Template("AdiqLiberoBundle:Reader:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('reader'));
        }
    ...
    private function createCreateForm(Reader $entity)
    {
        $form = $this->createForm(new ReaderType(), $entity, array(
            'action' => $this->generateUrl('reader_create'),
            'method' => 'POST',
        ));
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('AdiqLiberoBundle:Reader')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new ReaderType(), $entity, array(
            'action' => $this->generateUrl('reader_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="reader_update")
     * @Method("PUT")
     * @Template("AdiqLiberoBundle:Reader:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('reader_edit', array('id' => $id)));
        }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('reader_delete', array('id' => $id)))
            ->setMethod('DELETE')
